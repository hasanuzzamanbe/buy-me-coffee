        ...
        <div class="buymecoffee_main-menu-items">
            ...
            <ul class="buymecoffee_menu">
				<?php foreach ($menuItems as $item): ?>
                    ...
                    <li data-key="<?php echo esc_attr($item['key']); ?>" class="buymecoffee_menu_item <?php echo ($hasSubMenu) ? 'buymecoffee_has_sub_items' : ''; ?> buymecoffee_item_<?php echo esc_attr($item['key']); ?>">
